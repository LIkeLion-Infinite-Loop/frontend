...
export const CATEGORIES: Category[] = [
  ...
  { id: '4', name: 'UsedClothes', koreanName: '헌옷', icon: require('../assets/images/clothes.png') },
  ...
  { id: '7', name: 'SmallAppliances', koreanName: '소형가전', icon: require('../assets/images/elec.png') },
  { id: '8', name: 'FoodWaste', koreanName: '음식물쓰레기', icon: require('../assets/images/food.png') },
  { id: '9', name: 'OtherWaste', koreanName: '기타쓰레기', icon: require('../assets/images/other.png') },
];